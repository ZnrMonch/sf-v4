    ...
    <header class="group fixed pt-10 pb-10 w-20 hover:w-60 duration-500 ease-out h-screen flex flex-col justify-between bg-[#060d0d99] backdrop-blur-md shadow-[var(--around-shadow-md)] select-none z-10">
        ...
        <menu class="flex flex-col gap-2">
            ...
            <li><a href="admin.html" class="flex items-center gap-8 pl-5 py-2 hover:opacity-60 duration-200 ease-linear">
                ...
                <p class="text-lg overflow-hidden text-clip">Database</p>
            </a></li>
        </menu>
    </header>
    <!-- ================================================== MAIN ================================================== -->
    <main class="absolute right-0 m-5 p-15 w-[calc(100vw-120px)] min-h-[calc(100vh-40px)] h-auto rounded-4xl bg-[#eeeeee] z-2 text-black drag-none">
