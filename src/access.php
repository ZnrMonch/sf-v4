...
<body class="relative bg-[url('resources/lib-bg.jpg')] w-screen h-screen text-white">
    <style>
       body {
    ...
    <div class="absolute inset-0 bg-black/50 w-screen h-screen z-0"></div>
    <header class="group fixed pt-10 pb-10 w-20 hover:w-60 duration-500 ease-out h-screen flex flex-col justify-between backdrop-blur-sm shadow-2x select-none z-1">
        <div class="w-full h-35">
            ...
            <a href=""><h1 class="m-3.5 whitespace-nowrap overflow-hidden text-3xl opacity-0 group-hover:opacity-100 duration-500 ease-out">Scholar Finds</h1></a>
        </div>
        <nav>
        ...
        <menu class="flex flex-col gap-2">
            ...
            <li><a href="dbmanager.html" class="flex items-center gap-8 pl-5 py-2 hover:opacity-60 duration-200 ease-linear">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="min-w-8 w-8">
